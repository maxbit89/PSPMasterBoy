...
void gbe_updatePad()			{
	...
	//Le 1 est à gauche sur la SMS/GG, donc sur la GB/C ça correspond à B
		...
		switch (menuConfig.gameboy.gbType)			{
			case 0:
				...
				if (org_gbtype == 2 && gblModeColorIt)		{
					//Petit hack pour ne pas utiliser le SGB lorsqu'une ROM est colorisée
...
//‚Sƒoƒ“ƒN‚É•ª‚¯‚ÄAŒ»İo—Í’†‚¶‚á‚È‚¢ƒoƒ“ƒN‚É‘‚¢‚Ä‚¢‚­ - LCK
