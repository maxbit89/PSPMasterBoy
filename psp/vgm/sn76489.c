...
static VGM_SN76489_Context SN76489[MAX_SN76489];

void VGM_SN76489_Init(int which, int PSGClockValue, int SamplingRate)
{
    VGM_SN76489_Context *p = &SN76489[which];
    p->dClock=(float)PSGClockValue/16/SamplingRate;
    VGM_SN76489_Config(which, MUTE_ALLON, VOL_FULL, FB_SEGAVDP, SRW_SEGAVDP, 1);
    VGM_SN76489_Reset(which);
}
...
void VGM_SN76489_Config(int which, int mute, int volume, int feedback, int sr_width, int boost_noise)
{
    VGM_SN76489_Context *p = &SN76489[which];
...
{
    return sizeof(VGM_SN76489_Context);
}
...
void VGM_SN76489_SetMute(int which, int val)
{
  SN76489[which].Mute=val;
}

int  VGM_SN76489_GetVolType(int which)
{
  return SN76489[which].VolumeArray;
}

void VGM_SN76489_SetVolType(int which, int val)
{
  SN76489[which].VolumeArray=val;
}

void VGM_SN76489_SetPanning(int which, int ch0, int ch1, int ch2, int ch3)
{
