...
// Chris Swindle - Changing to set SND_NILL as the initial value, so that
//                 if a port does not want to use FM then it will not perform
//                 the update. The PSP port ran under 60fps for some GameGear
//		   games if this was set.
enum {
    SND_NILL,
